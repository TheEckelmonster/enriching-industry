...
data:extend({
    {
        ...
        order = "t-c-a[titanium-ore]-d[enriched]-d[stage-1]",
        hidden = not ci_ore_crushing,
        stack_size = 100,
        weight = 2 * kg,
    },
    {
        ...
        subgroup = "raw-resource",
        order = "t-c-a[titanium-ore]-d[enriched]-d[stage-2]",
        hidden = not ci_ore_crushing,
        stack_size = 100,
        weight = 2 * kg,
    },
    {
        ...
        subgroup = "raw-resource",
        order = "t-c-a[titanium-ore]-d[enriched]-d[stage-3]",
        hidden = not ci_ore_crushing,
        stack_size = 100,
        weight = 2 * kg,
    },
    ...
    data:extend({
        {
            ...
            subgroup = "raw-resource",
            order = "t-c-a[titanium-ore]-a[chemistry]-d[enriched]-b[direct]",
            enabled = false,
        ...
        },
        {
            ...
            subgroup = "raw-resource",
            order = "t-c-a[titanium-ore]-b-d[enriched]-c[stage-1]",
            enabled = false,
            allow_productivity = true,
            auto_recycle = false,
            energy_required = 9.6,
        ...
        },
        {
            ...
            category = type(mods) == "table" and mods["alloy-smelting"] and "kiln-smelting" or "smelting",
            subgroup = "raw-resource",
            order = "t-c-a[titanium-ore]-b-d[enriched]-c[stage-2]",
            enabled = false,
            allow_productivity = true,
            auto_recycle = false,
            energy_required = 9.6,
        ...
        },
        {
            ...
            category = type(mods) == "table" and mods["space-age"] and "chemistry-or-cryogenics" or "chemistry",
            subgroup = "raw-resource",
            order = "t-c-a[titanium-ore]-b-d[enriched]-c[stage-3]",
            enabled = false,
            allow_productivity = true,
            auto_recycle = false,
            energy_required = 8,
            ...
            results =
            {
                ...
                { type = "fluid", name = "ei-sulfuric-iron-solution",  amount_min = 1, amount_max = 5, probability = 0.7},
                { type = "fluid", name = "ei-tailing-slurry-titanium", amount_min = 5, amount_max = 10, ignored_by_productivity = 1000 },
            },
            main_product = "ei-enriched-titanium-ore",
            crafting_machine_tint = crafting_machine_tint,
        },
        -- MATERIAL
        {
            ...
            order = "d[titanium-plate]-a[smelting]-d[enriched]",
            enabled = false,
            allow_productivity = true,
            auto_recycle = false,
        ...
        type(mods) == "table" and mods["space-age"] and {
            ...
            category = "metallurgy",
            subgroup = "raw-material",
            order = "d[titanium-plate]-a[metallurgy]-d[enriched]",
            enabled = false,
            allow_productivity = true,
            auto_recycle = false,
            hide_from_player_crafting = ci_hide_player_crafting == true,
        ...
        } or nil,
        {
            ...
            results =
            {
                { type = "fluid", name = "ei-tailing-slurry",    amount_min = 1, amount_max = 10, },
        ...
        },
        {
            ...
            results =
            {
                { type = "fluid", name = "ei-tailing-slurry", amount_min = 5, amount_max = 10, },
                { type = "fluid", name = "water", amount = 20, ignored_by_productivity = 1000, },
